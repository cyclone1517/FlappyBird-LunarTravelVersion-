...
var Land = exports.Land = function (_Sprite) {
    ...
    function Land() {
        ...
        var _this = _possibleConstructorReturn(this, (Land.__proto__ || Object.getPrototypeOf(Land)).call(this, image, 0, 0, image.width, image.height, 0, _DataStore.DataStore.getInstance().canvas.height - image.height, image.width, image.height));

        _this.landX = 0;
        _this.landSpeed = _Director.Director.getIInstance().moveSpeed;
        return _this;
    }
    ...
    _createClass(Land, [{
        ...
        value: function draw() {
            ...
            if (this.landX + _DataStore.DataStore.getInstance().canvas.width > this.img.width) {
                this.landX = 0;
            }
